!> \file mo_wqm_objective_function.f90

!> \brief Objective Functions for Optimization of water quality model against runoff.\n

!> \details 
!>
!>         The objective functions are supposed to be minimized!                                      \n
!>               (31)  SO: Q+N:        ((1-NSE)**6+(1-lnNSE)**6)**(1/6)  for both runoff and nitrate    \n


!> \authors Xiaoqiang Yang  - Modified from mHM/mRM
!> \date Jul 2017
!  Modified 

MODULE mo_wqm_objective_function
...
CONTAINS
  ...
  FUNCTION wqm_objective(parameterset)
    ...
    case (31)
       ...
       wqm_objective = objective_power6_nse_lnnse(parameterset)
    case default
       stop "Error objective: This opti_function is either not implemented for water quality calibration yet."
    end select

  END FUNCTION wqm_objective
  ...
  !>        \author Stephan Thober
  !>        \date Oct 2015
  !     Modified,   Xiaoqiang Yang Aug 2017  - modified for WQM calibration
...
END MODULE mo_wqm_objective_function
